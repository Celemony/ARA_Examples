...
public:
                                    ...
                                    std::string& persistentID) const
    {
        ...
        return base64_decode (std::string_view { archive.child_value (ARA::kARAXMLName_ArchiveData) });
#else
        return base64_decode (archive.child_value (ARA::kARAXMLName_ArchiveData));
#endif
    }
