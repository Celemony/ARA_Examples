//------------------------------------------------------------------------------
//! \file       ARAArchives.h
//!             archive class used by the host to save/restore plug-in state
...
{
protected:
    ARAArchive (std::iostream& dataStream, const std::string& documentArchiveID) : _dataStream { dataStream }, _documentArchiveID { documentArchiveID } {}
...
class ARAMemoryArchive : public ARAArchive
{
public:
    // create empty
    ARAMemoryArchive (const std::string& documentArchiveID) : ARAArchive { _stream, documentArchiveID } {}
    // create with copy of existing data
    ARAMemoryArchive (const std::string& data, const std::string& documentArchiveID) : ARAArchive { _stream, documentArchiveID }, _stream { data } {}

    // copy current data
    operator const std::string () const noexcept { return _stream.str (); }
...
class ARAFileArchive : public ARAArchive
{
public:
    ARAFileArchive (std::string path, const std::string& documentArchiveID);
