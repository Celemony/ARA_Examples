...
void testContentUpdates (PlugInEntry* plugInEntry, const AudioFileList& audioFiles)
{
    ...
    constexpr auto audioSourceUpdateScope { musicalContextUpdateScope +
                                            ARA::ContentUpdateScopes::notesAreAffected () +
                                            ARA::ContentUpdateScopes::lyricsAreAffected () };
    araDocumentController->beginEditing ();
