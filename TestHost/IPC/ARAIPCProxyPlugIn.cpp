...
struct AudioSource
                  ...
                  : public InstanceValidator<AudioSource>
#endif
{
#if ARA_VALIDATE_API_CALLS
    AudioSource (ARAAudioSourceHostRef hostRef_, ARAAudioSourceRef remoteRef_, ARAChannelCount channelCount_,
                 ARASampleCount sampleCount_, ARASampleRate sampleRate_)
    : hostRef { hostRef_ }, remoteRef { remoteRef_ }, channelCount { channelCount_ },
      sampleCount { sampleCount_ }, sampleRate { sampleRate_ }
    {}
#endif

    ARAAudioSourceHostRef hostRef;
    ARAAudioSourceRef remoteRef;
...
#if ARA_VALIDATE_API_CALLS
                     : public InstanceValidator<ContentReader>
#endif
{
#if ARA_VALIDATE_API_CALLS
    ContentReader (ARAContentReaderRef remoteRef_, ARAContentType type_)
    : remoteRef { remoteRef_ }, decoder { type_ }
    {}
#endif

    ARAContentReaderRef remoteRef;
  ...
  _instance { this }
{
    ...
    _remoteRef = remoteCallWithReply<ARADocumentControllerRef> (kCreateDocumentControllerMethodID,
...
bool DocumentController::restoreObjectsFromArchive (ARAArchiveReaderHostRef archiveReaderHostRef, const ARARestoreObjectsFilter* filter) noexcept
{
    ...
    return (remoteCallWithReply<ARABool> (
                PLUGIN_METHOD_ID (ARADocumentControllerInterface, restoreObjectsFromArchive), _remoteRef, archiveReaderHostRef, filter) != kARAFalse);
}
...
bool DocumentController::storeObjectsToArchive (ARAArchiveWriterHostRef archiveWriterHostRef, const ARAStoreObjectsFilter* filter) noexcept
{
    ...
    if ((filter != nullptr) && (filter->audioSourceRefsCount > 0))
    {
        ...
        for (auto i { 0U }; i < filter->audioSourceRefsCount; ++i)
            remoteAudioSourceRefs.emplace_back (fromRef (filter->audioSourceRefs[i])->remoteRef);
    ...
    return (remoteCallWithReply<ARABool> (
                PLUGIN_METHOD_ID (ARADocumentControllerInterface, storeObjectsToArchive), _remoteRef, archiveWriterHostRef, filter) != kARAFalse);
}
...
bool DocumentController::storeAudioSourceToAudioFileChunk (ARAArchiveWriterHostRef archiveWriterHostRef, ARAAudioSourceRef audioSourceRef, ARAPersistentID* documentArchiveID, bool* openAutomatically) noexcept
{
    ...
    const auto replyMsg { remoteCallWithReply<IPCMessage> (
                            PLUGIN_METHOD_ID (ARADocumentControllerInterface, storeAudioSourceToAudioFileChunk), _remoteRef, archiveWriterHostRef, audioSource->remoteRef) };
...
ARAMusicalContextRef DocumentController::createMusicalContext (ARAMusicalContextHostRef hostRef, PropertiesPtr<ARAMusicalContextProperties> properties) noexcept
{
    ...
    const auto musicalContextRef { remoteCallWithReply<ARAMusicalContextRef> (
                PLUGIN_METHOD_ID (ARADocumentControllerInterface, createMusicalContext), _remoteRef, hostRef, *properties) };
...
ARARegionSequenceRef DocumentController::createRegionSequence (ARARegionSequenceHostRef hostRef, PropertiesPtr<ARARegionSequenceProperties> properties) noexcept
{
    ...
    const auto regionSequenceRef { remoteCallWithReply<ARARegionSequenceRef> (
                PLUGIN_METHOD_ID (ARADocumentControllerInterface, createRegionSequence), _remoteRef, hostRef, *properties) };
...
ARAAudioSourceRef DocumentController::createAudioSource (ARAAudioSourceHostRef hostRef, PropertiesPtr<ARAAudioSourceProperties> properties) noexcept
{
    ...
    audioSource->remoteRef = remoteCallWithReply<ARAAudioSourceRef> (
                PLUGIN_METHOD_ID (ARADocumentControllerInterface, createAudioSource), _remoteRef, ARAAudioSourceHostRef { toHostRef (audioSource) }, *properties);
...
ARAAudioModificationRef DocumentController::createAudioModification (ARAAudioSourceRef audioSourceRef, ARAAudioModificationHostRef hostRef, PropertiesPtr<ARAAudioModificationProperties> properties) noexcept
{
    ...
    const auto audioModificationRef { remoteCallWithReply<ARAAudioModificationRef> (
                PLUGIN_METHOD_ID (ARADocumentControllerInterface, createAudioModification), _remoteRef, audioSource->remoteRef, hostRef, *properties) };
...
ARAAudioModificationRef DocumentController::cloneAudioModification (ARAAudioModificationRef srcAudioModificationRef, ARAAudioModificationHostRef hostRef, PropertiesPtr<ARAAudioModificationProperties> properties) noexcept
{
    ...
    const auto clonedAudioModificationRef { remoteCallWithReply<ARAAudioModificationRef> (
                PLUGIN_METHOD_ID (ARADocumentControllerInterface, cloneAudioModification), _remoteRef, srcAudioModificationRef, hostRef, *properties) };
...
ARAPlaybackRegionRef DocumentController::createPlaybackRegion (ARAAudioModificationRef audioModificationRef, ARAPlaybackRegionHostRef hostRef, PropertiesPtr<ARAPlaybackRegionProperties> properties) noexcept
{
    ...
    const auto playbackRegionRef { remoteCallWithReply<ARAPlaybackRegionRef> (
                PLUGIN_METHOD_ID (ARADocumentControllerInterface, createPlaybackRegion), _remoteRef, audioModificationRef, hostRef, *properties) };
...
void DocumentController::getPlaybackRegionHeadAndTailTime (ARAPlaybackRegionRef playbackRegionRef, ARATimeDuration* headTime, ARATimeDuration* tailTime) noexcept
{
    ...
    const auto reply { remoteCallWithReply<ARAIPCGetPlaybackRegionHeadAndTailTimeReply> (
                PLUGIN_METHOD_ID (ARADocumentControllerInterface, getPlaybackRegionHeadAndTailTime), _remoteRef, playbackRegionRef, (headTime != nullptr) ? kARATrue : kARAFalse, (tailTime != nullptr) ? kARATrue : kARAFalse) };
    if (headTime != nullptr)
...
bool DocumentController::isAudioSourceContentAvailable (ARAAudioSourceRef audioSourceRef, ARAContentType type) noexcept
{
    ...
    return (remoteCallWithReply<ARABool> (
                PLUGIN_METHOD_ID (ARADocumentControllerInterface, isAudioSourceContentAvailable), _remoteRef, audioSource->remoteRef, type) != kARAFalse);
}
...
ARAContentGrade DocumentController::getAudioSourceContentGrade (ARAAudioSourceRef audioSourceRef, ARAContentType type) noexcept
{
    ...
    return remoteCallWithReply<ARAContentGrade> (
                PLUGIN_METHOD_ID (ARADocumentControllerInterface, getAudioSourceContentGrade), _remoteRef, audioSource->remoteRef, type);
}
...
ARAContentReaderRef DocumentController::createAudioSourceContentReader (ARAAudioSourceRef audioSourceRef, ARAContentType type, const ARAContentTimeRange* range) noexcept
{
    ...
    const auto contentReaderRef { remoteCallWithReply<ARAContentReaderRef> (
                PLUGIN_METHOD_ID (ARADocumentControllerInterface, createAudioSourceContentReader), _remoteRef, audioSource->remoteRef, type, range) };
...
bool DocumentController::isAudioModificationContentAvailable (ARAAudioModificationRef audioModificationRef, ARAContentType type) noexcept
{
    ...
    return (remoteCallWithReply<ARABool> (
                PLUGIN_METHOD_ID (ARADocumentControllerInterface, isAudioModificationContentAvailable), _remoteRef, audioModificationRef, type) != kARAFalse);
}
...
ARAContentGrade DocumentController::getAudioModificationContentGrade (ARAAudioModificationRef audioModificationRef, ARAContentType type) noexcept
{
    ...
    return remoteCallWithReply<ARAContentGrade> (
                PLUGIN_METHOD_ID (ARADocumentControllerInterface, getAudioModificationContentGrade), _remoteRef, audioModificationRef, type);
}
...
ARAContentReaderRef DocumentController::createAudioModificationContentReader (ARAAudioModificationRef audioModificationRef, ARAContentType type, const ARAContentTimeRange* range) noexcept
{
    ...
    const auto contentReaderRef { remoteCallWithReply<ARAContentReaderRef> (
                PLUGIN_METHOD_ID (ARADocumentControllerInterface, createAudioModificationContentReader), _remoteRef, audioModificationRef, type, range) };
...
bool DocumentController::isPlaybackRegionContentAvailable (ARAPlaybackRegionRef playbackRegionRef, ARAContentType type) noexcept
{
    ...
    return (remoteCallWithReply<ARABool> (
                PLUGIN_METHOD_ID (ARADocumentControllerInterface, isPlaybackRegionContentAvailable), _remoteRef, playbackRegionRef, type) != kARAFalse);
}
...
ARAContentGrade DocumentController::getPlaybackRegionContentGrade (ARAPlaybackRegionRef playbackRegionRef, ARAContentType type) noexcept
{
    ...
    return remoteCallWithReply<ARABool> (
                PLUGIN_METHOD_ID (ARADocumentControllerInterface, getPlaybackRegionContentGrade), _remoteRef, playbackRegionRef, type);
}
...
ARAContentReaderRef DocumentController::createPlaybackRegionContentReader (ARAPlaybackRegionRef playbackRegionRef, ARAContentType type, const ARAContentTimeRange* range) noexcept
{
    ...
    const auto contentReaderRef { remoteCallWithReply<ARAContentReaderRef> (
                PLUGIN_METHOD_ID (ARADocumentControllerInterface, createPlaybackRegionContentReader), _remoteRef, playbackRegionRef, type, range) };
...
ARAInt32 DocumentController::getContentReaderEventCount (ARAContentReaderRef contentReaderRef) noexcept
{
    ...
    return remoteCallWithReply<ARAInt32> (
                PLUGIN_METHOD_ID (ARADocumentControllerInterface, getContentReaderEventCount), _remoteRef, contentReader->remoteRef);
}
...
const void* DocumentController::getContentReaderDataForEvent (ARAContentReaderRef contentReaderRef, ARAInt32 eventIndex) noexcept
{
    ...
    return contentReader->decoder.decode (remoteCallWithReply<IPCMessage> (
                PLUGIN_METHOD_ID (ARADocumentControllerInterface, getContentReaderDataForEvent), _remoteRef, contentReader->remoteRef, eventIndex));
}
...
bool DocumentController::isAudioSourceContentAnalysisIncomplete (ARAAudioSourceRef audioSourceRef, ARAContentType type) noexcept
{
    ...
    return (remoteCallWithReply<ARAContentGrade> (
                PLUGIN_METHOD_ID (ARADocumentControllerInterface, isAudioSourceContentAnalysisIncomplete), _remoteRef, audioSource->remoteRef, type) != kARAFalse);
}
...
ARAInt32 DocumentController::getProcessingAlgorithmsCount () noexcept
{
    ...
    return remoteCallWithReply<ARAInt32> (PLUGIN_METHOD_ID (ARADocumentControllerInterface, getProcessingAlgorithmsCount), _remoteRef);
}
...
const ARAProcessingAlgorithmProperties* DocumentController::getProcessingAlgorithmProperties (ARAInt32 algorithmIndex) noexcept
{
    ...
    // keep local copy of message before decoding it so that all pointer data remains valid until properly copied
    const auto replyMsg { remoteCallWithReply<IPCMessage> (PLUGIN_METHOD_ID (ARADocumentControllerInterface, getProcessingAlgorithmProperties), _remoteRef, algorithmIndex) };
    const auto reply { decodeReply<ARAProcessingAlgorithmProperties> (replyMsg) };
...
ARAInt32 DocumentController::getProcessingAlgorithmForAudioSource (ARAAudioSourceRef audioSourceRef) noexcept
{
    ...
    return remoteCallWithReply<ARAInt32> (PLUGIN_METHOD_ID (ARADocumentControllerInterface, getProcessingAlgorithmForAudioSource), _remoteRef, audioSource->remoteRef);
}
...
bool DocumentController::isLicensedForCapabilities (bool runModalActivationDialogIfNeeded, ARASize contentTypesCount, const ARAContentType contentTypes[], ARAPlaybackTransformationFlags transformationFlags) noexcept
{
    ...
    types.assign (contentTypes, contentTypes + contentTypesCount);
    return (remoteCallWithReply<ARABool> (
                PLUGIN_METHOD_ID (ARADocumentControllerInterface, isLicensedForCapabilities), _remoteRef, (runModalActivationDialogIfNeeded) ? kARATrue : kARAFalse, types, transformationFlags) != kARAFalse);
}
                                 ...
                                 ARASamplePosition samplePosition, ARASampleCount samplesPerChannel)
{
    ...
    bufferData.resize (sizeof (FloatT) * static_cast<size_t> (reader->audioSource->channelCount * samplesPerChannel));
    void* sampleBuffers[32];
    ARA_INTERNAL_ASSERT(reader->audioSource->channelCount < 32);
    for (auto i { 0 }; i < reader->audioSource->channelCount; ++i)
...
//  ARA_LOG ("_plugInCallbackDispatcher received message %s", decodeHostMethodID (messageID));
    ...
    if (messageID == HOST_METHOD_ID (ARAAudioAccessControllerInterface, createAudioReaderForSource))
    {
        ...
        reader->hostRef = documentController->getHostAudioAccessController ()->createAudioReaderForSource (audioSource->hostRef, (use64BitSamples) ? kARATrue : kARAFalse);
    ...
    else if (messageID == HOST_METHOD_ID (ARAContentAccessControllerInterface, createAudioSourceContentReader))
    {
        ...
        auto hostContentReader { new HostContentReader };
        hostContentReader->hostRef = documentController->getHostContentAccessController ()->createAudioSourceContentReader (audioSource->hostRef, contentType, (range.second) ? &range.first : nullptr);
        hostContentReader->contentType = contentType;
        return encodeReply (ARAContentReaderHostRef { toHostRef (hostContentReader) });
    }
